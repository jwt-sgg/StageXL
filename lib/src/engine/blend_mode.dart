...
class BlendMode {
  ...
  static const BlendMode NORMAL = const BlendMode(gl.ONE, gl.ONE_MINUS_SRC_ALPHA, "source-over");
  ...
  static const BlendMode ADD = const BlendMode(gl.ONE, gl.ONE, "lighter");
  ...
  static const BlendMode MULTIPLY = const BlendMode(gl.DST_COLOR, gl.ONE_MINUS_SRC_ALPHA, "multiply");
  ...
  /// the display object.
  static const BlendMode SCREEN = const BlendMode(gl.ONE, gl.ONE_MINUS_SRC_COLOR, "screen");

  /// Erases the background based on the alpha value of the display object.
  static const BlendMode ERASE = const BlendMode(gl.ZERO, gl.ONE_MINUS_SRC_ALPHA, "destination-out");
  ...
  static const BlendMode BELOW = const BlendMode(gl.ONE_MINUS_DST_ALPHA, gl.ONE, "destination-over");
  ...
  static const BlendMode ABOVE = const BlendMode(gl.DST_ALPHA, gl.ONE_MINUS_SRC_ALPHA, "source-atop");
  ...
  /// pixels.
  static const BlendMode NONE = const BlendMode(gl.ONE, gl.ZERO, "source-over");
}
